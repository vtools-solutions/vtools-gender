...

{
  ...
  "description": "Serviço Identificação de Gênero por nome",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  ...
  },
  {
    ...
    "displayName": "Nome",
    "simpleValueType": true,
    "help": "Informe um nome para buscar o Genero"
  }
]
...
const geUrl = 'https://api.vtools.com.br/api_gender.js';
...
const gender = () => {
  const ge = copyFromWindow('Gender');    
  ge.getGender(handleResponse, data.apiKey, data.name);

};

injectScript(geUrl, gender, error, 'gender');
      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://api.vtools.com.br/api_gender.js"
              }
            ]
          }
        }
